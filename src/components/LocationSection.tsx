          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 mb-12 sm:mb-16">
            <div className="animate-on-scroll">
              ...
              <div className="mt-8 p-4 sm:p-6 bg-primary/5 rounded-xl">
                <h4 className="font-bold text-base sm:text-lg mb-3">Horário de Atendimento</h4>
          ...
          <div className="text-center animate-on-scroll">
            <Card className="border border-border/50 shadow-card">
              <CardContent className="p-6 sm:p-8">
                ...
                <h3 className="text-lg sm:text-xl font-bold mb-4">Visite Nosso Escritório</h3>
                <p className="text-muted-foreground mb-6 text-sm sm:text-base max-w-2xl mx-auto px-2">
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center max-w-md mx-auto">
                  <a
                    ...
                    className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-primary text-primary-foreground rounded-md hover:bg-primary/90 transition-colors text-sm sm:text-base w-full sm:w-auto"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 bg-accent text-accent-foreground rounded-md hover:bg-accent/90 transition-colors text-sm sm:text-base w-full sm:w-auto"
                  >
